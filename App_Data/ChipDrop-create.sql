...
CREATE TABLE ChipDisposal ( -- producers looking to sell.
...
CREATE TABLE ChipRequest( -- Consumers looking to buy.
	...
	CONSTRAINT ChipRequest_qty_id_fk FOREIGN KEY (qty_id)
			REFERENCES ChipQty (qty_id)
);
